  ...
  return (
    <Section layers='01' title='3RS of Sustainability' image={p1} alt="p1-img" headerStyles='xl:mr-[21rem] 2xl:mr-[37rem]' layersStyles='text-[5rem]'>
      <div className='flex flex-col gap-2'>
        <p className='xl:w-[1200px] xl:font-medium xl:text-[2.3rem]'>Reduce, Reuse, and Recycle (or the 3Rs) are crucial for environmental preservation because they encourage sustainable and ethical production and consumption methods that help protect natural resources, lessen waste and pollution, and lessen the damaging effects of human activity on the environment.</p>

        <div className='flex flex-col gap-2 xl:flex-row xl:gap-12 xl:mt-[1rem]'>
          <p className='xl:w-[400px]'><span className='font-bold'>Waste reduction</span>: The first 3R is to reduce waste. We can conserve natural resources and reduce the amount of waste that ends up in landfills or pollutes our environment by minimizing the resources we use and the waste we produce.</p>
