  ...
  return (
    <Section layers='01' title='3RS of Sustainability' image={p1} alt="p1-img" headerStyles='xl:mr-[21rem] 2xl:mr-[37rem]' >
      <div className='flex flex-col gap-2 xl:mt-[2rem]'>
        <p className='xl:w-[950px] xl:font-light xl:text-[2.3rem] 2xl:w-[1200px]'>Reduce, Reuse, and Recycle (or the 3Rs) are crucial for environmental preservation because they encourage sustainable and ethical production and consumption methods that <span className="font-medium">help protect natural resources</span>, lessen waste and pollution, and lessen the damaging effects of human activity on the environment.</p>
